    ...
    <el-container>
          ...
          <ul>
            ...
            <li :class="getNum > 0 ? 'shopCart-full' : 'shopCart'">
              <router-link to="/shoppingCart">
                <i class="el-icon-shopping-cart-full"></i> My Cart
      ...
      <el-header>
        ...
        >
          ...
          <div class="so">
            <el-input placeholder="Please enter search content" v-model="search">
        ...
        <div class="footer">
          <div class="ng-promise-box">
            <div class="ng-promise">
              <p class="text">
                <a class="icon1" href="javascript:;">Free return and exchange</a>
                <a class="icon2" href="javascript:;">Free shipping</a>
                <a class="icon3" style="margin-right: 0" href="javascript:;">Quality Assured</a>
              </p>
            </div>
          </div>
          <div class="github">
          ...
          <div class="mod_help">
            ...
            <p class="coty">Copyright &copy; 2023-2024</p>
          </div>
        </div>
      </el-footer>
      <!-- 底栏容器END -->
