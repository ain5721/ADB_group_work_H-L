  ...
  <div id="details">
    ...
    <div class="page-header">
      <div class="title">
        ...
        <div class="list">
          <ul>
            <li>
              <router-link to>Sketch</router-link>
            </li>
            <li>
    ...
    <div class="main">
      ...
      <div class="block">
        <el-carousel height="560px" v-if="productPicture.length>1">
          <el-carousel-item v-for="item in productPicture" :key="item.id">
            <img style="height:560px;" :src="$resource + item.product_picture" :alt="item.intro" />
          </el-carousel-item>
        </el-carousel>
        <div v-if="productPicture.length==1">
          <img
            style="height:560px;"
            :src="$resource + productPicture[0].product_picture"
      ...
      <div class="content">
        ...
        <p class="store">Mi</p>
        <div class="price">
          <span>{{productDetails.product_selling_price}}yen</span>
          <span
            v-show="productDetails.product_price != productDetails.product_selling_price"
            class="del"
          >{{productDetails.product_price}}yen</span>
        </div>
        <div class="pro-list">
          ...
          <p class="price-sum">Total : {{productDetails.product_selling_price}}yen</p>
        </div>
        <!-- 内容区底部按钮 -->
        <div class="button">
        ...
        <div class="pro-policy">
          <ul>
            <li>
              <i class="el-icon-circle-check"></i> Official Authentic
            </li>
            <li>
              <i class="el-icon-circle-check"></i> Fast Shipping
            </li>
            <li>
              <i class="el-icon-circle-check"></i> refund without reason
            </li>
            <li>
              <i class="el-icon-circle-check"></i> quality assurance
            </li>
          </ul>
        </div>
      </div>
