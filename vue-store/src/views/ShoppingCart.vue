  ...
  <div class="shoppingCart">
    ...
    <div class="cart-header">
      <div class="cart-header-content">
        ...
        <span>Whether the product has been successfully purchased depends on the final order placed. Please settle as soon as possible</span>
      </div>
    </div>
    <!-- 购物车头部END -->
    ...
    <div class="content" v-if="getShoppingCart.length>0">
      <ul>
        ...
        <li class="product-list" v-for="(item,index) in getShoppingCart" :key="item.id">
          ...
          <div class="pro-price">{{item.price}}yen</div>
          <div class="pro-num">
            <el-input-number
              size="small"
              :value="item.num"
          ...
          <div class="pro-total pro-total-in">{{item.price*item.num}}yen</div>
      ...
      <div class="cart-bar">
        <div class="cart-bar-left">
          ...
          <span class="cart-total">
            <span class="cart-total-num">{{getNum}}</span> in total,
            <span class="cart-total-num">{{getCheckNum}}</span> chosen
          </span>
        </div>
        <div class="cart-bar-right">
          <span>
            <span class="total-price-title">Total amount: </span>
            <span class="total-price">{{getTotalPrice}}yen</span>
          </span>
